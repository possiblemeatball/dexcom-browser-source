...
class SystemTrayIcon(QSystemTrayIcon):
    def __init__(self, app: QApplication, parent: QObject, app_config: AppConfig):
        ...
        self.about_dialog: AboutDialog = AboutDialog(parent=None, app=self._app, app_config=self._app_config)
        ...
        self.setContextMenu(self.create_context_menu())
    ...
    def create_context_menu(self) -> QMenu:
        ...
        _ = self._quit_action.triggered.connect(self._app.quit)
