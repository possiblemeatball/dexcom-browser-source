...
class SystemTrayIcon(QSystemTrayIcon):
    def __init__(self, parent: QObject):
        ...
        self._status_action: QAction = QAction()
    ...
    def create_actions(self):
        self._status_action = QAction("Waitress Status", self)
    ...
    def create_context_menu(self):
        context_menu = QMenu()
        context_menu.addAction(QAction("Waitress", self, enabled=False))
        _ = context_menu.addSeparator()
        context_menu.addAction(self._status_action)
        context_menu.addAction(QAction("Dexcom Browser Source", self, enabled=False))
        _ = context_menu.addSeparator()
